namespace AuthentificationApi.Presentation.Tests.Unit.Endpoints;

using System.Threading.Tasks;
using AuthentificationApi.Application.Authors.Entities;
using AuthentificationApi.Application.Common.Exceptions;
using AuthentificationApi.Application.Movies.Entities;
using MediatR;
